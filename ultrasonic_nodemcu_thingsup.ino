...
const int trigger=D6;                               // Trigger pin of the Ultrasonic Sensor
const int echo=D7;                                  // Echo pin of the Ultrasonic Sensor
...
void loop() {
  ...
  if (millis() - current_millis > 5000)
  {
    ...
    if (client.connected())
    {
      ...
      String publish_topic = "/"  + accountID + "/" + "dist";   // The topic name should be always start with /accountID/
